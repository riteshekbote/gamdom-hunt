...
24/7 deep multi-model bug-hunting automation for **Gamdom** (Oliver Maicher bug-bounty hub).

Scope: All company-owned infrastructure, gaming engines, wallets, APIs, user accounts, web/mobile applications, and domains operated by Gamdom
...
> is never accepted. Active testing is gated behind the in-scope hosts in `inventory/gamdom.md` and
...
Program description: Online crypto casino platform offering gaming and betting services
